    ...
    public partial class MigrationInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AluguelProduto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AluguelProduto_Aluguel_AluguelId",
                        column: x => x.AluguelId,
                        principalTable: "Aluguel",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AluguelProduto_Produto_ProdutoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AluguelProduto_AluguelId",
                table: "AluguelProduto",
                column: "AluguelId");

            migrationBuilder.CreateIndex(
                name: "IX_AluguelProduto_ProdutoId",
                table: "AluguelProduto",
                column: "ProdutoId");
